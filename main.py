...
WEBHOOK_URL = f"https://adminbot-jkfv.onrender.com{WEBHOOK_PATH}"
...
async def text_handler(msg: types.Message):
    ...
    if state == "wait_channel":
        try:
            ...
            return await msg.answer("❌ Kanal/guruh ID raqam bo‘lishi kerak")
        ...
        try:
            ...
            return await msg.answer("❌ Guruh ID raqam bo‘lishi kerak")
